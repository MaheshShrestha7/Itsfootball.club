...
import { Award, Plus, Trash2, Edit2, Shield, CheckCircle2 } from 'lucide-react';
...
export default function AdminCommitteePage({
  ...
  const { clubs, selectClubBySlug, members, appointExecutive, updateMember } = useClub();
  ...
  const handleAppoint = (e: React.FormEvent) => {
    ...
    appointExecutive(selectedMemberId, title, bio, order);
    setFeedback(`Successfully appointed to executive committee!`);
    ...
    <div>
      ...
      <div className="glass-panel" style={{ padding: '2rem' }}>
        <h3 style={{ fontSize: '1.2rem', fontWeight: 800, color: '#FFFFFF', marginBottom: '1.5rem' }}>
          Current Executive Board ({executiveMembers.length})
        </h3>
