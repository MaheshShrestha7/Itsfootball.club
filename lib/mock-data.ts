...
export const INITIAL_MATCHES: Match[] = [
  // 1. Currently LIVE Match!
  {
    id: 'match-live-01',
    club_id: 'club-apex-01',
    title: 'Metro Derby Clash 2026/27',
    match_type: 'tournament',
    competition: 'Premier Metropolitan League',
    season: '2026/27',
    opponent_name: 'Metro Rovers',
    opponent_short_name: 'ROV',
    ...
    description: 'High-octane derby match against local arch-rivals Metro Rovers. Gates open at 18:00. Matchday program and merchandise available at North Stand.',
    status: 'live',
    featured_on_hero: true,
    door_qr_checkin_enabled: true,
    door_qr_code: 'door-match-live-01',
    checkin_count: 142,
    home_score: 2,
    away_score: 1,
    current_minute: 71,
  ...
  // 2. Upcoming High Stakes Derby
  {
    ...
    club_id: 'club-apex-01',
    title: 'Metropolitan Super Cup Semi-Final',
    match_type: 'tournament',
    competition: 'Metropolitan Super Cup (Semi-Final)',
    season: '2026/27',
    opponent_name: 'Titan Athletic FC',
    opponent_short_name: 'TIT',
    ...
    match_flyer_url: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=1600&auto=format&fit=crop&q=80',
    description: 'Knockout semi-final fixture away at Titan Colosseum. Away supporter bay located in Section 14. Live stream on Apex TV.',
    status: 'upcoming',
    featured_on_hero: true,
    door_qr_checkin_enabled: true,
    door_qr_code: 'door-match-upcoming-02',
    checkin_count: 0,
    home_score: 0,
    away_score: 0,
    current_minute: 0,
  ...
  // 3. Past Result
  {
    id: 'match-past-03',
    club_id: 'club-apex-01',
    title: 'Home League Opener',
    match_type: 'tournament',
    competition: 'Premier Metropolitan League',
    season: '2025/26',
    opponent_name: 'St. Jude United',
    opponent_short_name: 'STJ',
    home_team_name: 'Apex City FC',
    ...
    match_time: '16:00',
    venue: 'Apex Park Stadium',
    match_flyer_url: 'https://images.unsplash.com/photo-1517466787929-bc90951d0974?w=1600&auto=format&fit=crop&q=80',
    description: 'Dominant 3-0 victory in the home curtain-raiser. Clean sheet secured.',
    status: 'completed',
    featured_on_hero: false,
    door_qr_checkin_enabled: true,
    door_qr_code: 'door-match-past-03',
    checkin_count: 310,
    home_score: 3,
    away_score: 0,
    current_minute: 90,
  ...
  // 4. Past Result
  {
    id: 'match-past-04',
    club_id: 'club-apex-01',
    title: 'Harbor Away Fixture',
    match_type: 'friendly',
    competition: 'Premier Metropolitan League',
    season: '2025/26',
    opponent_name: 'Harbor City Rangers',
    opponent_short_name: 'HBR',
    ...
    match_flyer_url: 'https://images.unsplash.com/photo-1522778119026-d647f0596c20?w=1600&auto=format&fit=crop&q=80',
    description: 'Hard-fought 2-1 away triumph with a stoppage-time match-winner.',
    status: 'completed',
    featured_on_hero: false,
    door_qr_checkin_enabled: false,
    checkin_count: 85,
    home_score: 1,
    away_score: 2,
    current_minute: 90,
...
// ==============================================================================
// 23. INTERNAL TEAMS & TOURNAMENTS (Challonge Parity for Football)
// ==============================================================================

export const INITIAL_INTERNAL_TEAMS: InternalTeam[] = [
  {
    id: 'team-apex-01',
    club_id: 'club-apex-01',
    name: 'Apex First Team',
    short_name: 'ACFC-1',
    color: '#10B981',
    logo_url: '/crests/apex-city.svg',
    cover_url: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=1200&auto=format&fit=crop&q=80',
    captain_id: 'player-apex-01',
    coach_name: 'Diego Morales',
    player_ids: ['player-apex-01', 'player-apex-02', 'player-apex-03', 'player-apex-04', 'player-apex-05'],
    created_at: '2026-08-01T00:00:00.000Z',
  },
  {
    id: 'team-apex-02',
    club_id: 'club-apex-01',
    name: 'Apex U-21 Academy',
    short_name: 'AC-U21',
    color: '#3B82F6',
    logo_url: '/crests/red-lions.svg',
    cover_url: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=1200&auto=format&fit=crop&q=80',
    captain_id: 'player-apex-06',
    coach_name: 'Marcus Sterling',
    player_ids: ['player-apex-06', 'player-apex-07', 'player-apex-08', 'player-apex-09'],
    created_at: '2026-08-01T00:00:00.000Z',
  },
  {
    id: 'team-apex-03',
    club_id: 'club-apex-01',
    name: 'Apex Veterans & Staff',
    short_name: 'AC-VET',
    color: '#F59E0B',
    logo_url: '/crests/apex-city.svg',
    cover_url: 'https://images.unsplash.com/photo-1517466787929-bc90951d0974?w=1200&auto=format&fit=crop&q=80',
    captain_id: 'mem-apex-01',
    coach_name: 'Eleanor Vance',
    player_ids: ['mem-apex-01', 'mem-apex-02', 'mem-apex-03', 'mem-apex-04'],
    created_at: '2026-08-01T00:00:00.000Z',
  },
  {
    id: 'team-apex-04',
    club_id: 'club-apex-01',
    name: 'Apex Yellow Submarines',
    short_name: 'AYS',
    color: '#EAB308',
    logo_url: '/crests/red-lions.svg',
    cover_url: 'https://images.unsplash.com/photo-1522778119026-d647f0596c20?w=1200&auto=format&fit=crop&q=80',
    captain_id: 'player-apex-10',
    coach_name: 'David Silva',
    player_ids: ['player-apex-10', 'player-apex-11'],
    created_at: '2026-08-01T00:00:00.000Z',
  },
];
...
export const INITIAL_TOURNAMENTS: Tournament[] = [
  {
    id: 'tourn-apex-01',
    club_id: 'club-apex-01',
    name: 'Apex Summer Intra-Club Cup',
    slug: 'apex-summer-cup',
    season: '2026/27',
    ...
    end_date: '2026-09-30',
    venue: 'Apex Park Stadium Arena',
    description: 'Prestigious annual intra-club football tournament bringing together first-team athletes, academy prospects, and invitational community squads.',
  ...
  },
  {
    id: 'tourn-apex-02',
    club_id: 'club-apex-01',
    name: 'Metropolitan Super Cup',
    slug: 'metro-super-cup',
    season: '2026/27',
    format: 'knockout',
    status: 'ongoing',
    points_win: 3,
    ...
    end_date: '2026-10-15',
    venue: 'Apex Park Stadium Arena',
    description: 'Single-elimination championship featuring top 8 regional powerhouse clubs competing for the prestigious Metropolitan Trophy.',
  ...
  },
  {
    id: 'tourn-apex-03',
    club_id: 'club-apex-01',
    name: 'Premier Apex Community League',
    slug: 'apex-community-league',
    season: '2026/27',
    format: 'league',
    status: 'ongoing',
    points_win: 3,
    ...
    start_date: '2026-08-01',
    end_date: '2026-12-15',
    venue: 'Apex Training Ground (Pitch 1)',
    description: 'All-play-all round-robin tournament for internal squads and regional partner academies.',
    banner_url: 'https://images.unsplash.com/photo-1517466787929-bc90951d0974?w=1600&auto=format&fit=crop&q=80',
    created_at: '2026-08-01T00:00:00.000Z',
  },
];

export const INITIAL_TOURNAMENT_PARTICIPANTS: TournamentParticipant[] = [
  // Tourn 1: Group Stage + Knockout (8 Teams)
  {
    id: 'part-t1-01',
    tournament_id: 'tourn-apex-01',
    team_type: 'internal',
    internal_team_id: 'team-apex-01',
    name: 'Apex First Team',
    short_name: 'ACFC-1',
    logo_url: '/crests/apex-city.svg',
    color: '#10B981',
  ...
  },
  {
    ...
    name: 'St. Jude United',
    short_name: 'STJ',
    logo_url: 'https://images.unsplash.com/photo-1489944445391-11dd35366433?w=100&auto=format&fit=crop&q=80',
    color: '#8B5CF6',
    seed: 3,
    group: 'A',
  },
  {
    ...
    name: 'Metro Rovers',
    short_name: 'ROV',
    logo_url: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=100&auto=format&fit=crop&q=80',
    color: '#EF4444',
    seed: 4,
    group: 'A',
  },
  ...
  // Tourn 2: Metropolitan Super Cup (Knockout 8 Teams)
  {
    id: 'part-t2-01',
    tournament_id: 'tourn-apex-02',
    team_type: 'internal',
    internal_team_id: 'team-apex-01',
    name: 'Apex First Team',
    short_name: 'ACFC-1',
  ...
  },
  {
    ...
    tournament_id: 'tourn-apex-02',
    team_type: 'external',
    name: 'Port City Athletic',
    short_name: 'PCA',
    logo_url: 'https://images.unsplash.com/photo-1517466787929-bc90951d0974?w=100&auto=format&fit=crop&q=80',
    seed: 5,
  },
  {
    id: 'part-t2-06',
  ...
  // Tourn 3: League (6 Teams)
  {
    id: 'part-t3-01',
    tournament_id: 'tourn-apex-03',
    team_type: 'internal',
    internal_team_id: 'team-apex-01',
    name: 'Apex First Team',
    short_name: 'ACFC-1',
...
export const INITIAL_TOURNAMENT_MATCHES: Match[] = [
  // --- Metropolitan Super Cup (Knockout 8 Teams) ---
  // Quarter-Final 1: Apex First Team (1) vs Valley Rangers (8) [Completed 3-1]
  {
    id: 'match-tourn-tourn-apex-02-r1-m1',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-02',
    competition: 'Metropolitan Super Cup',
    season: '2026/27',
    match_type: 'tournament',
    ...
    home_team_name: 'Apex First Team',
    away_team_name: 'Valley Rangers',
    home_team_logo: '/crests/apex-city.svg',
    away_team_logo: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=100&auto=format&fit=crop&q=80',
    home_team_source: 'Seed #1',
    away_team_source: 'Seed #8',
    is_club_home: true,
    ...
    match_format: '11v11',
    next_match_id: 'match-tourn-tourn-apex-02-r2-m1',
    next_match_slot: 'home',
  },
  // Quarter-Final 2: St. Jude United (4) vs Port City Athletic (5) [Completed 2-2, 5-4 pens]
  {
    id: 'match-tourn-tourn-apex-02-r1-m2',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-02',
    competition: 'Metropolitan Super Cup',
    season: '2026/27',
    ...
    home_team_name: 'St. Jude United',
    away_team_name: 'Port City Athletic',
    home_team_logo: 'https://images.unsplash.com/photo-1489944445391-11dd35366433?w=100&auto=format&fit=crop&q=80',
    away_team_logo: 'https://images.unsplash.com/photo-1517466787929-bc90951d0974?w=100&auto=format&fit=crop&q=80',
    home_team_source: 'Seed #4',
    away_team_source: 'Seed #5',
    is_club_home: false,
    match_date: '2026-09-05',
    match_time: '18:00',
    venue: 'Apex Park Stadium Arena',
  ...
  // Quarter-Final 3: Titan Athletic FC (2) vs Apex U-21 Academy (7) [Completed 2-0]
  {
    id: 'match-tourn-tourn-apex-02-r1-m3',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-02',
    competition: 'Metropolitan Super Cup',
    season: '2026/27',
    ...
    tournament_stage: 'quarter_final',
    tournament_round: 1,
    tournament_match_number: 3,
    home_team_name: 'Titan Athletic FC',
    away_team_name: 'Apex U-21 Academy',
    home_team_logo: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=100&auto=format&fit=crop&q=80',
    away_team_logo: '/crests/red-lions.svg',
    home_team_source: 'Seed #2',
    away_team_source: 'Seed #7',
    is_club_home: false,
    ...
    away_formation: '4-4-2',
    match_format: '11v11',
    next_match_id: 'match-tourn-tourn-apex-02-r2-m2',
    next_match_slot: 'home',
  },
  // Quarter-Final 4: Metro Rovers (3) vs Northern Lions (6) [LIVE 1-0 at 72']
  {
    id: 'match-tourn-tourn-apex-02-r1-m4',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-02',
    competition: 'Metropolitan Super Cup',
    season: '2026/27',
    ...
    tournament_stage: 'quarter_final',
    tournament_round: 1,
    tournament_match_number: 4,
    home_team_name: 'Metro Rovers',
    away_team_name: 'Northern Lions',
    home_team_logo: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=100&auto=format&fit=crop&q=80',
    away_team_logo: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=100&auto=format&fit=crop&q=80',
    home_team_source: 'Seed #3',
    away_team_source: 'Seed #6',
    is_club_home: false,
    match_date: '2026-09-06',
    match_time: '18:00',
    venue: 'Metro Grounds',
  ...
  // Semi-Final 1: Apex First Team vs St. Jude United [Upcoming]
  {
    id: 'match-tourn-tourn-apex-02-r2-m1',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-02',
    competition: 'Metropolitan Super Cup',
    season: '2026/27',
    ...
    tournament_round: 2,
    tournament_match_number: 5,
    home_team_name: 'Apex First Team',
    away_team_name: 'St. Jude United',
    home_team_logo: '/crests/apex-city.svg',
    away_team_logo: 'https://images.unsplash.com/photo-1489944445391-11dd35366433?w=100&auto=format&fit=crop&q=80',
    home_team_source: 'Winner M#1',
    away_team_source: 'Winner M#2',
    is_club_home: true,
    ...
    away_formation: '4-2-3-1',
    match_format: '11v11',
    next_match_id: 'match-tourn-tourn-apex-02-r3-m1',
    next_match_slot: 'home',
  },
  // Semi-Final 2: Titan Athletic FC vs TBD [Upcoming]
  {
    id: 'match-tourn-tourn-apex-02-r2-m2',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-02',
    competition: 'Metropolitan Super Cup',
    season: '2026/27',
    ...
    tournament_stage: 'semi_final',
    tournament_round: 2,
    tournament_match_number: 6,
    home_team_name: 'Titan Athletic FC',
    away_team_name: 'Metro Rovers',
    home_team_logo: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=100&auto=format&fit=crop&q=80',
    away_team_logo: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=100&auto=format&fit=crop&q=80',
    home_team_source: 'Winner M#3',
    away_team_source: 'Winner M#4',
    is_club_home: false,
  ...
  {
    id: 'match-tourn-tourn-apex-02-r3-m1',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-02',
    competition: 'Metropolitan Super Cup',
    season: '2026/27',
    ...
    tournament_round: 3,
    tournament_match_number: 7,
    home_team_name: 'Winner Semi-Final 1',
    away_team_name: 'Winner Semi-Final 2',
    home_team_logo: '/crests/apex-city.svg',
    away_team_logo: '/crests/red-lions.svg',
    home_team_source: 'Winner M#5',
    away_team_source: 'Winner M#6',
    is_club_home: true,
  ...
  // 3rd Place Playoff [Upcoming]
  {
    id: 'match-tourn-tourn-apex-02-third-place',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-02',
    competition: 'Metropolitan Super Cup',
    season: '2026/27',
    ...
    tournament_round: 3,
    tournament_match_number: 8,
    home_team_name: 'Loser Semi-Final 1',
    away_team_name: 'Loser Semi-Final 2',
    home_team_logo: '/crests/apex-city.svg',
    away_team_logo: '/crests/red-lions.svg',
    home_team_source: 'Loser M#5',
    away_team_source: 'Loser M#6',
    is_club_home: true,
    match_date: '2026-10-10',
    match_time: '14:00',
    venue: 'Apex Park Stadium Arena',
  ...
  // --- Apex Summer Intra-Club Cup (Group Stage + Knockout) ---
  // Group A:
  {
    id: 'match-tourn-tourn-apex-01-ga-m1',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
    match_type: 'tournament',
  ...
  {
    id: 'match-tourn-tourn-apex-01-ga-m2',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
  ...
  {
    id: 'match-tourn-tourn-apex-01-ga-m3',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
  ...
  {
    id: 'match-tourn-tourn-apex-01-ga-m4',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
    ...
    tournament_round: 2,
    tournament_match_number: 4,
    home_team_name: 'Apex U-21 Academy',
    away_team_name: 'St. Jude United',
    home_team_logo: '/crests/red-lions.svg',
    away_team_logo: 'https://images.unsplash.com/photo-1489944445391-11dd35366433?w=100&auto=format&fit=crop&q=80',
    is_club_home: true,
    match_date: '2026-08-23',
    match_time: '17:30',
  ...
  {
    id: 'match-tourn-tourn-apex-01-ga-m5',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
    match_type: 'tournament',
    title: 'Group A • Matchday 3',
    tournament_stage: 'group',
    tournament_group: 'Group A',
    tournament_round: 3,
    tournament_match_number: 5,
  ...
  {
    id: 'match-tourn-tourn-apex-01-ga-m6',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
  ...
  // Group B:
  {
    id: 'match-tourn-tourn-apex-01-gb-m1',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
    match_type: 'tournament',
    title: 'Group B • Matchday 1',
    tournament_stage: 'group',
    tournament_group: 'Group B',
    tournament_round: 1,
    tournament_match_number: 7,
    home_team_name: 'Apex Veterans & Staff',
    away_team_name: 'Titan Athletic FC',
    home_team_logo: '/crests/apex-city.svg',
    away_team_logo: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=100&auto=format&fit=crop&q=80',
    is_club_home: true,
  ...
  {
    id: 'match-tourn-tourn-apex-01-gb-m2',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
    ...
    tournament_round: 1,
    tournament_match_number: 8,
    home_team_name: 'Apex Yellow Submarines',
    away_team_name: 'Ironworks FC',
    home_team_logo: '/crests/red-lions.svg',
    away_team_logo: 'https://images.unsplash.com/photo-1508098682722-e99c43a406b2?w=100&auto=format&fit=crop&q=80',
    is_club_home: true,
    match_date: '2026-08-17',
  ...
  {
    id: 'match-tourn-tourn-apex-01-gb-m3',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
    match_type: 'tournament',
    title: 'Group B • Matchday 2',
    tournament_stage: 'group',
    tournament_group: 'Group B',
    tournament_round: 2,
    tournament_match_number: 9,
    home_team_name: 'Apex Veterans & Staff',
    away_team_name: 'Apex Yellow Submarines',
    home_team_logo: '/crests/apex-city.svg',
    away_team_logo: '/crests/red-lions.svg',
    is_club_home: true,
  ...
  {
    id: 'match-tourn-tourn-apex-01-gb-m4',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
  ...
  {
    id: 'match-tourn-tourn-apex-01-ko-sf1',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
    ...
    tournament_stage: 'semi_final',
    tournament_round: 1,
    tournament_match_number: 11,
    home_team_name: '1st Group A (Apex First Team)',
    away_team_name: '2nd Group B (Titan Athletic FC)',
    home_team_logo: '/crests/apex-city.svg',
    away_team_logo: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=100&auto=format&fit=crop&q=80',
    home_team_source: '1st Group A',
    away_team_source: '2nd Group B',
    next_match_id: 'match-tourn-tourn-apex-01-ko-final',
    next_match_slot: 'home',
    is_club_home: true,
  ...
  {
    id: 'match-tourn-tourn-apex-01-ko-sf2',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
    ...
    away_team_name: '2nd Group A (Apex U-21 Academy)',
    home_team_logo: '/crests/apex-city.svg',
    away_team_logo: '/crests/red-lions.svg',
  ...
  {
    id: 'match-tourn-tourn-apex-01-ko-final',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
    ...
    tournament_stage: 'final',
    tournament_round: 2,
    tournament_match_number: 13,
    home_team_name: 'Winner Semi-Final 1',
    away_team_name: 'Winner Semi-Final 2',
    home_team_logo: '/crests/apex-city.svg',
    away_team_logo: '/crests/red-lions.svg',
    home_team_source: 'Winner SF1',
    away_team_source: 'Winner SF2',
    is_club_home: true,
  ...
  {
    id: 'match-tourn-tourn-apex-01-ko-third-place',
    club_id: 'club-apex-01',
    tournament_id: 'tourn-apex-01',
    competition: 'Apex Summer Intra-Club Cup',
    season: '2026/27',
    ...
    tournament_stage: 'third_place',
    tournament_round: 2,
    tournament_match_number: 14,
    home_team_name: 'Loser Semi-Final 1',
    away_team_name: 'Loser Semi-Final 2',
    home_team_logo: '/crests/apex-city.svg',
    away_team_logo: '/crests/red-lions.svg',
    home_team_source: 'Loser SF1',
    away_team_source: 'Loser SF2',
    is_club_home: true,
    match_date: '2026-09-25',
    match_time: '14:00',
    venue: 'Apex Park Stadium Arena',
