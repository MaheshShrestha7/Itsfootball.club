...
export function generateKnockoutBracket(
  ...
  for (let m = 0; m < round1MatchCount; m++) {
    ...
    const newMatch: Match = {
      ...
      home_team_logo: p1 ? p1.logo_url : '/crests/apex-city.svg',
      away_team_logo: p2 ? p2.logo_url : '/crests/red-lions.svg',
  ...
  for (let r = 2; r <= totalRounds; r++) {
    ...
    for (let m = 0; m < currMatchCount; m++) {
      ...
      let homeName = 'TBD';
      let awayName = 'TBD';
      let homeLogo = '/crests/apex-city.svg';
      let awayLogo = '/crests/red-lions.svg';
  ...
  for (let r = 0; r < numRounds; r++) {
    ...
    for (let m = 0; m < matchesPerRound; m++) {
      ...
      matches.push({
        ...
        home_team_logo: home.logo_url || '/crests/apex-city.svg',
        away_team_logo: away.logo_url || '/crests/red-lions.svg',
        is_club_home: true,
        match_date: roundDate.toISOString().slice(0, 10),
        match_time: defaultTime,
        venue: defaultVenue,
...
export function computeStandings(
  ...
  targetParticipants.forEach(p => {
    standingsMap.set(p.name, {
      ...
      logo_url: p.logo_url || '/crests/apex-city.svg',
      group: p.group,
      played: 0,
      won: 0,
      drawn: 0,
